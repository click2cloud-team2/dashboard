...
var (
	...
	argSidecarHost = pflag.String("sidecar-host", "", "The address of the Sidecar Apiserver "+
		...
		"Kubernetes cluster and service proxy will be used.")
	argKubeConfigFile     = pflag.String("kubeconfig", "", "Path to kubeconfig file with authorization and master location clustermanagement.")
...
func handleFatalInitError(err error) {
	log.Fatalf("Error while initializing connection to Kubernetes apiserver. "+
		...
		"Refer to our FAQ and wiki pages for more clustermanagement: "+
...
func CreateTable() {
	...
	sqlStatement := `CREATE TABLE IF NOT EXISTS users (userid SERIAL PRIMARY KEY,username TEXT,password TEXT,token TEXT,type TEXT);`
